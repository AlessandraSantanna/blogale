            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 mt-5 text-pink-900" data-aos="fade-up-left" data-aos-delay="300">
                ...
                <ul className="list-disc list-inside text-xl space-y-2">
                  ...
                  <p>No Tailwind CSS aprendemos a criar aplicações web dinâmicas e interativas, usando componentes, estados e hooks para controlar o comportamento da interface de forma organizada e reutilizável.</p>
                  <li>Componentes</li>
