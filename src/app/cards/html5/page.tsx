            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 mt-5 text-pink-900" data-aos="fade-up-left" data-aos-delay="300">
                ...
                <ul className="list-disc list-inside text-xl space-y-2">
                  ...
                  <li>É a linguagem padrão para criação de páginas da Web</li>
                  <li>Descreve a estrutura de uma página</li>
                  <li>Consiste em uma série de elementos</li>
                  <li>Os elementos informam ao navegador como exibir o conteúdo</li>
                  <li>É a espinha dorsal de todas as páginas da Web</li>
                </ul>
              </div>
            </div>
