...
export const cardsData: CardType[] = [
  {
    ...
    image: "/html5.png",
   content: "Html5 é a quinta versão do HTML.",
   link: "/cards/html5",
    category: "frontend"
  ...
  },
   {
    id: "css3",
    title: "CSS3",
    description: "Se o HTML é o esqueleto, o CSS é a decoração. Ele dá vida à página, definindo cores, fontes, layouts e até mesmo como ela se adapta a diferentes tamanhos de tela (o que chamamos de responsividade). Com ele, a casa ganha cores, móveis e estilo.",
    image: "/css.png",
  ...
  },
  {
  ...
  },
   {
    id: "javascript",
    title: "JavaScript",
    description: "Essa é a linguagem que adiciona a interatividade. É o motor que faz as coisas acontecerem. Com o JavaScript, podemos criar animações, validar formulários, mostrar ou esconder elementos e muito mais. É o que transforma uma página estática em uma experiência dinâmica.",
    image: "/js.jpg",
  ...
  }, 
  {
    id: "nextjs",
    title: "Next.js",
    description: "Este foi o \"coringa\" do curso. O Next.js é um framework completo, que usa React no front, mas também tem recursos poderosos no back-end. Ele nos ajuda a construir aplicações mais robustas e eficientes.",
    image: "/next.js.jpg",
